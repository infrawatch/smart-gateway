...
RUN yum  localinstall ./repo/epel-release-latest-7.noarch.rpm -y && \
  yum localinstall ./repo/libserf-1.3.9-1.el7.x86_64.rpm -y &&\
  yum localinstall ./repo/mercurial-3.4-0.x86_64.rpm -y && \
  yum localinstall ./repo/subversion-1.11.0-1.x86_64.rpm -y && \
